...
<div>
    ...
    <div class='container-fluid'>
        <div class='row'>
            ...
            <div v-if='item' class='col-sm-12 mt-5 bg-white min-100vh text-dark pt-5 col-md-8 col-lg-4'>
                ...
                <infinite-loading @infinite="scrollBottomData"></infinite-loading>
            </div>
            <div class='col-sm-12 col-md-2 col-lg-4'></div>
        </div>
    </div>
...
export default {
    ...
    methods: {
        scrollBottomData($state) {
            ...
            this.$axios('https://limitless-sea-61725.herokuapp.com/https://masak-apa-tomorisakura.vercel.app/api/categorys/recipes/' + this.$route.params.key + "/" + this.page)
                .then(res => {
    ...
    mounted() {
        this.$axios('https://limitless-sea-61725.herokuapp.com/https://masak-apa-tomorisakura.vercel.app/api/categorys/recipes/' + this.$route.params.key)
            .then(res => {
                this.item = [];
                let h = res.data.results;
